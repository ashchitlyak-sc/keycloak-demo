...
public class KeycloakSmsAuthenticatorFactory implements AuthenticatorFactory, ConfigurableAuthenticatorFactory {
    ...
    private static Logger LOG = Logger.getLogger(KeycloakSmsAuthenticatorFactory.class);
    ...
    @Override
    public String getId() {
        LOG.debug("getId called ... returning " + PROVIDER_ID);
        return PROVIDER_ID;
    }

    @Override
    public Authenticator create(KeycloakSession session) {
        LOG.debug("create called ... returning " + SINGLETON);
        return SINGLETON;
    }

    @Override
    public AuthenticationExecutionModel.Requirement[] getRequirementChoices() {
        LOG.debug("getRequirementChoices called ... returning " + REQUIREMENT_CHOICES);
        return REQUIREMENT_CHOICES;
    }

    @Override
    public boolean isUserSetupAllowed() {
        LOG.debug("isUserSetupAllowed called ... returning true");
        return true;
    }
    ...
    public boolean isConfigurable() {
        boolean result = true;
        LOG.debug("isConfigurable called ... returning " + result);
        return result;
    }

    @Override
    public String getHelpText() {
        LOG.debug("getHelpText called ...");
    ...
    public String getDisplayType() {
        ...
        LOG.debug("getDisplayType called ... returning " + result);
        return result;
    }

    @Override
    public String getReferenceCategory() {
        LOG.debug("getReferenceCategory called ... returning sms-auth-code");
        return "sms-auth-code";
    }

    @Override
    public List<ProviderConfigProperty> getConfigProperties() {
        LOG.debug("getConfigProperties called ... returning " + configProperties);
        return configProperties;
    }

    @Override
    public void init(Config.Scope config) {
        LOG.debug("init called ... config.scope = " + config);
    }

    @Override
    public void postInit(KeycloakSessionFactory factory) {
        LOG.debug("postInit called ... factory = " + factory);
    }
